...
export default function VocabularyStudy() {
  const { certType, topicId } = useParams<{ certType: 'ielts' | 'toeic', topicId: string }>();
    ...
    <div className="animate-fade-in" style={{ maxWidth: '850px', margin: '0 auto', paddingBottom: '4rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <button 
            ...
            onClick={() => navigate(`/${certType}/practice/matching`)}
          >
      ...
      <div style={{ marginTop: '3rem', display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
        ...
        <button 
          ...
          onClick={() => navigate(`/${certType}/practice/fill-blank`)}
        >
