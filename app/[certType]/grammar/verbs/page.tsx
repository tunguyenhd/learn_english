...
import { irregularVerbsData } from '@/lib/data/grammar';
  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: '900px', margin: '0 auto', paddingBottom: '4rem' }}>
      ...
      <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h2 style={{ color: brandColor }}>Irregular Verbs</h2>
          <p style={{ color: 'var(--text-secondary)' }}>Bảng tra cứu động từ bất quy tắc.</p>
        </div>
        ...
        <div style={{ position: 'relative', width: '100%', maxWidth: '300px' }}>
          ...
          <input
            type="text"
            placeholder="Search verb (e.g. go, went, đi)..."
            style={{
              width: '100%',
